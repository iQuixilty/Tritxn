...
module.exports = {
    ...
    category: "Misc",
    aliases: ["col"],
    description: "Displays some info on a color",
    usage: "\`PREFIXcolor [hex color]\`",
    ...
    execute: async function (client, message, args) {
        ...
        if (message.mentions.members.first()) {
            ...
            if (/(#|0x)([0-9A-F]{6})/i.test(args[0])) {
                ...
                message.channel.send(colorE.setColor(message.guild.me.displayColor).setDescription('**Make sure its hex | Example: #FF0000 | 0xFF0000**'))
                return
            }
        } else {
